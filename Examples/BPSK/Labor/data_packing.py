...
class data_packing(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Data package test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Data package test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "data_packing")
...
def main(top_block_cls=data_packing, options=None):
