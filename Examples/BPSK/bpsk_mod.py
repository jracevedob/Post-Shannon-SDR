...
class bpsk_mod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_freq = center_freq = 4
        ...
        self.connect((self.blocks_interleaved_char_to_complex_0, 0), (self.qtgui_const_sink_x_1, 0))
        ...
        self.connect((self.digital_psk_demod_0, 0), (self.blocks_interleaved_char_to_complex_0, 0))
