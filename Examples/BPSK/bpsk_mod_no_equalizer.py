...
class bpsk_mod_no_equalizer(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Bpsk Mod No Equalizer")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Bpsk Mod No Equalizer")
        ...
        self.settings = Qt.QSettings("GNU Radio", "bpsk_mod_no_equalizer")
        ...
        # Blocks
        ##################################################
        self._delay_tx_range = Range(5, 75, 1, 29, 200)
        self._delay_tx_win = RangeWidget(self._delay_tx_range, self.set_delay_tx, 'Delay', "counter_slider", float)
        self.top_grid_layout.addWidget(self._delay_tx_win, 0, 0, 1, 4)
        for r in range(0, 1):
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_1_win, 2, 0, 1, 4)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_win, 1, 0, 1, 4)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.connect((self.digital_costas_loop_cc_0, 0), (self.qtgui_time_sink_x_0_1, 0))
...
def main(top_block_cls=bpsk_mod_no_equalizer, options=None):
