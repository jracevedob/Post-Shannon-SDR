...
class qpsk_mod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Qpsk Mod")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Qpsk Mod")
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_mod")
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, phase_bw, rrc_taps, 32, 16, 1.5, 4)
...
def main(top_block_cls=qpsk_mod, options=None):
