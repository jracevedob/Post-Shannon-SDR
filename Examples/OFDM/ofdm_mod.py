...
class ofdm_mod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Ofdm Mod")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Ofdm Mod")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ofdm_mod")
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_0_win, 5, 0, 1, 4)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.digital_ofdm_cyclic_prefixer_0 = digital.ofdm_cyclic_prefixer(fft_len, fft_len + 16, 0, "frame_len")
        self.digital_ofdm_carrier_allocator_cvc_0 = digital.ofdm_carrier_allocator_cvc( fft_len, ((-2, -1, 1, 3), (-3, -1, 1, 2)), ((-3, 2), (-2, 3)), ((-1, 1j), (1, -1j), (-1, 1j), (-1j, 1)), [0., 0., 0., 0., 0., 0., 0., 1.41421356, 0., -1.41421356, 0., 1.41421356, 0., -1.41421356, 0., -1.41421356, 0., -1.41421356, 0., 1.41421356, 0., -1.41421356, 0., 1.41421356, 0., -1.41421356, 0., -1.41421356, 0., -1.41421356, 0., -1.41421356, 0., 1.41421356, 0., -1.41421356, 0., 1.41421356, 0., 1.41421356, 0., 1.41421356, 0., -1.41421356, 0., 1.41421356, 0., 1.41421356, 0., 1.41421356, 0., -1.41421356, 0., 1.41421356, 0., 1.41421356, 0., 1.41421356, 0., 0., 0., 0., 0., 0.], "packet_len", True)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/supersonic/GitHub/Post-Shannon-SDR/Examples/BPSK/testFiles/test_file', True, 0, 0)
        ...
        self.connect((self.digital_ofdm_carrier_allocator_cvc_0, 0), (self.digital_ofdm_cyclic_prefixer_0, 0))
        self.connect((self.digital_ofdm_cyclic_prefixer_0, 0), (self.digital_cma_equalizer_cc_0, 0))
        self.connect((self.digital_ofdm_cyclic_prefixer_0, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.digital_ofdm_cyclic_prefixer_0, 0), (self.qtgui_time_sink_x_2, 0))
...
def main(top_block_cls=ofdm_mod, options=None):
